...
* 						ADDING ELEMENTS
*************************************************************** */
// These methods return a new length of the array
...
* 						REMOVING ELEMENTS
*************************************************************** */
// these returns the element you are removing
...
// TO DO: Use a combination of .pop and .shift methods until only 'fortuna' and 'ganymede' are left in the array. Log the updated array.
...
// TO DO: If the last element in the fruits array is 'grapes', remove it from the list.
    ...
    //checking to see if lastIndexOf 'grapes' (in this case it equals 6) === the last index of the array (fruit.length - 1)
...
// this method DOES NOT modify the original, instead returns a new array
// pretty much like copy pasting a portion of an array
// inclusive of the first index BUT the second index you pass is NOT included

var instructors = ['justin','david','sophie','vivian','casey','trant','daniel'];

// TO DO TOGETHER: Create a variable named ganymedeInstructors that stores an array list of 'justin','david', and 'sophie'. Do this with the .slice method.

    var ganymedeInstructors = instructors.slice(0,3);
    console.log(ganymedeInstructors);

// TO DO TOGETHER: Create a variable named fortunaInstructors that stores an array list of all instructors starting from 'vivian' onward.
...
//Modifies the original array and will return the reversed original array
...
// .sort will convert elements in an array to their string equivalent and sort based on those values in order to sort the elements. But when outputted the original data types are preserved

//sorts by spaces then numbers then alphabetical
...
//.split allows us to turn a string into an array
//.join allows us to turn arrays into strings

//does NOT modify, but returns a new array
...
// TO DO: Now, join the array elements into a string. Each word should be in its own separate line. Log your results.

    var submarineString = submarineArray.join('\n');
    console.log(submarineString);